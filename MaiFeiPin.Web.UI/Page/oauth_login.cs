    ...
    public partial class oauth_login : Web.UI.BasePage
    {
        ...
        void UserPage_Init(object sender, EventArgs e)
        {
            ...
            if (oauthModel != null)
            {
				...
				Utils.WriteCookie(DTKeys.COOKIE_USER_NAME_REMEMBER, "maifeipin", model.user_name);
				Utils.WriteCookie(DTKeys.COOKIE_USER_PWD_REMEMBER, "maifeipin", model.password);
                //更新最新的Access Token
