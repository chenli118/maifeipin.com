...
namespace MaiFeiPin.Web.UI.Page
{
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            if (action == "exit")
            {
                ...
                //清除Cookies
				Utils.WriteCookie(DTKeys.COOKIE_USER_NAME_REMEMBER, "maifeipin", -43200);
				Utils.WriteCookie(DTKeys.COOKIE_USER_PWD_REMEMBER, "maifeipin", -43200);
				Utils.WriteCookie("UserName", "maifeipin", -1);
				Utils.WriteCookie("Password", "maifeipin", -1);
                //自动登录,跳转URL
