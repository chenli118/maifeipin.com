<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="MaiFeiPin.Web.admin.index" %>
    ...
    <div class="nav-right">
      <div class="icon-info">
        <span>
          ...
          <%=new MaiFeiPin.BLL.manager_role().GetTitle(admin_info.role_id) %>
        </span>
      </div>
