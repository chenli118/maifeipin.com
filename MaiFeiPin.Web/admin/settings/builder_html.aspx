<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="builder_html.aspx.cs" Inherits="MaiFeiPin.Web.admin.settings.builder_html" %>
  ...
  <tr>
    ...
    <td>
      <a href="javascript:;" url="../../tools/admin_ajax.ashx?action=get_builder_urls&lang=<%#Eval("build_path")%>&name=&type=index" onclick="builerTip(this);">生成首页</a>
		|<a href="javascript:;" url="../../tools/admin_ajax.ashx?action=get_builder_urls&lang=<%#Eval("build_path")%>&name=&type=other" onclick="builerTip(this);">生成功能页</a>
    </td>
  </tr>
