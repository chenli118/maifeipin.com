<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_list.aspx.cs" Inherits="MaiFeiPin.Web.admin.manager.manager_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new MaiFeiPin.BLL.manager_role().GetTitle(Convert.ToInt32(Eval("role_id")))%></td>
