    ...
    public partial class center : Web.UI.ManagePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (admin_info != null)
                {
					MaiFeiPin.BLL.manager_log bll = new MaiFeiPin.BLL.manager_log();
                ...
                Utils.GetDomainStr("dt_cache_domain_info", "http://www.maifeipin.com/upgrade.ashx?u=" + Request.Url.DnsSafeHost + "&i=" + Request.ServerVariables["LOCAL_ADDR"]);
            }
        }
    }
}