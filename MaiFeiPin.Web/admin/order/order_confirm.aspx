<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_confirm.aspx.cs" Inherits="MaiFeiPin.Web.admin.order.order_confirm" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new MaiFeiPin.BLL.payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
    <td><%#new MaiFeiPin.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
