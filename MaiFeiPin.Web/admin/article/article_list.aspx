<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_list.aspx.cs" Inherits="MaiFeiPin.Web.admin.article.article_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new MaiFeiPin.BLL.article_category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
