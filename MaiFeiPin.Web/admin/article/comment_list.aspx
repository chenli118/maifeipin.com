<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_list.aspx.cs" Inherits="MaiFeiPin.Web.admin.article.comment_list" %>
  ...
  <tr>
    <td class="comment">
      <div class="title">
        ...
        <%#new MaiFeiPin.BLL.article().GetTitle(Convert.ToInt32(Eval("article_id")))%>
      </div>
      <div class="ask">
