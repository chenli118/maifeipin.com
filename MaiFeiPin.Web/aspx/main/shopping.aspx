<%@ Page Language="C#" AutoEventWireup="true" Inherits="MaiFeiPin.Web.UI.Page.shopping" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	IList<MaiFeiPin.Model.cart_items> ls1 = get_cart_list();

	foreach(MaiFeiPin.Model.cart_items modelt in ls1)
	{
	...
	IList<MaiFeiPin.Model.cart_items> ls2 = get_cart_list();

	foreach(MaiFeiPin.Model.cart_items modelt in ls2)
	{
