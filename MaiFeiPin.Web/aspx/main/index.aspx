<%@ Page Language="C#" AutoEventWireup="true" Inherits="MaiFeiPin.Web.UI.Page.index" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable linkList1 = get_plugin_method("MaiFeiPin.Web.Plugin.Link", "link", "get_link_list", 0, "is_lock=0 and is_image=0 and is_red=1");
	...
	templateBuilder.Append("\r\n    </p>\r\n    <div class=\"img\">\r\n      <ul>\r\n        ");
	DataTable linkList2 = get_plugin_method("MaiFeiPin.Web.Plugin.Link", "link", "get_link_list", 9, "is_lock=0 and is_image=1 and is_red=1");
